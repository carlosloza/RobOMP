...
% Missing entries noise (fixed rate)
% Author: Carlos Loza
...
% Notes:
% ------
% - Sparsity level of sparse coders is set incrementally until reaching 
% ground truth
% - Fixed missing entries rate
% - Several number of iterations are allowed
% - Execution time is not tracked
