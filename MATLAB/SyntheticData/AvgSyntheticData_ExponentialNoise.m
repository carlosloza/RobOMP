...
% Notes:
% ------
% - Several noise means and number of iterations are allowed
% - Execution time is tracked as well
% - Setting the mean to 1 will yield the averages summarized in Table 3 of 
% RobOMP article
