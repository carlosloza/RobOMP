...
for bp_i = 1:length(bprate_v)
    bp = bprate_v(bp_i);   
    BSize = round(sqrt(((192*168)*downsamp^2).*(bp))); 
    for rep = 1:nRep
        clc
        ...
        ClassOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassgOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassCMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassCauchyOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassFairOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassHuberOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassTukeyOMP(:, rep, bp_i) = ct_right./ct_all;
        ...
        ClassWelschOMP(:, rep, bp_i) = ct_right./ct_all;
    end 
end
