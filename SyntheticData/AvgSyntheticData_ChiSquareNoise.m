...
% 3. Additive chi-square noise is added to samples
...
% Notes:
% ------
% - Several noise degrees of freedom and number of iterations are allowed
% - Execution time is tracked as well
% - Setting the degrees of freedom to 1 will yield the averages summarized 
...
dof_v = 1:6;                % Set of degrees of freedom of added chi-square noise       
ndof = length(dof_v);
...
for i = 1:ndof
    ...
    for it = 1:n_it
        ...
        y = D*x0;        
        % Add chi-square noise
        ynoi = y + chi2rnd(dof_v(i), size(y));
        y = ynoi;
...
xlabel('Chi-square additive noise degrees of freedom')
